    ...
    <>
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <form className="space-y-6 mt-6" onSubmit={(e) => { e.preventDefault(); handleSubmit(`http://localhost:8000/api/users/${user.id}/update_Full_Name`, { Full_Name: formData.full_name }); }}>
            <div className="grid grid-cols-1 gap-4">
              <div>
          ...
          <form className="space-y-6 mt-6" onSubmit={(e) => { e.preventDefault(); handleSubmit(`http://localhost:8000/api/users/${user.id}/update_delivery_info`, { address: formData.address, city: formData.city, country: formData.country, zip: formData.zip }); }}>
          ...
          <form className="space-y-6 mt-6" onSubmit={(e) => { e.preventDefault(); handleSubmit(`http://localhost:8000/api/users/${user.id}/update_payment_info`, { holder: formData.holder, holder_identification_number: formData.holder_identification_number, currency: formData.currency, credit_card_number: formData.credit_card_number, expiration_date: formData.expiration_date, security_code: formData.security_code }); }}>
            <div className="grid grid-cols-2 gap-4">
              <div>
