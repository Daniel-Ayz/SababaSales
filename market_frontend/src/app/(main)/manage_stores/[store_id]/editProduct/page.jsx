...
export default function EditProduct({ params }) {
    ...
    async function editProduct(event) {
        ...
        try {
            const response = await axios.put(`${process.env.NEXT_PUBLIC_STORES_ROUTE}${store_id}/edit_product`, productData, {
            ...
            let errorMessage = 'There was an error editing the product.';
